...
INSERT INTO goals (user_id, summary, description, goal, movement, units, start_date, end_date, active) VALUES 
(2, 'money', 'cash is king, I need to stack this paper', 20000, 'total_up', 'dollars', '2021-09-01', '2021-10-01', true);
INSERT INTO goals (user_id, summary, description, goal, movement, units, start_date, end_date, active) VALUES
(2, 'student debt', 'I want to pay off all of this student debt', 0, 'total_down', 'dollars', '2021-03-01', '2021-04-20', false);
INSERT INTO goals (user_id, summary, description, goal, movement, units, start_date, end_date, active) VALUES 
(2, 'Wake up time', 'the early bird gets the worm right?', 0545, 'average_down', 'time', '2021-10-01', '2021-12-01', false);
